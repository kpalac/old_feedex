...
class FeedexFeedWindow(Gtk.ScrolledWindow):
    ...
    def __init__(self, parent, *args, **kargs):
        ...
        # Feed Tree
        self.feed_column_types = (GdkPixbuf.Pixbuf, int, str, str, str, int, str, int, str)
...
Hit <b>Ctrl-F</b> for interactive search""")
    ...
    def reload_feeds(self, *args, **kargs):
        ...
        if self.parent.curr_place == FX_PLACE_LAST: 
            new_row = self.feed_store_tmp.append(None, (self.parent.icons.get('new'), -1, f'<b><u>New</u></b>', '', None, FX_PLACE_LAST, None, 0, None))        
        else: 
            new_row = self.feed_store_tmp.append(None, (self.parent.icons.get('new'), -1, 'New', '', None, FX_PLACE_LAST, None, 0, None))

        if self.parent.curr_place == FX_PLACE_PREV_LAST: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -7, '<b><u>Previous Update</u></b>', '', None, FX_PLACE_PREV_LAST, None, 0, None))
        else: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -7, 'Previous Update', '', None, FX_PLACE_PREV_LAST, None, 0, None))

        if self.parent.curr_place == FX_PLACE_LAST_HOUR: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -2, '<b><u>Last Hour</u></b>', '', None, FX_PLACE_LAST_HOUR, None, 0, None))
        else: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -2, 'Last Hour', '', None, FX_PLACE_LAST_HOUR, None, 0, None))

        if self.parent.curr_place == FX_PLACE_TODAY: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -3, '<b><u>Today</u></b>', '', None, FX_PLACE_TODAY, None, 0, None))
        else: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -3, 'Today', '', None, FX_PLACE_TODAY, None, 0, None))
 
        if self.parent.curr_place == FX_PLACE_LAST_WEEK: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -4, '<b><u>This Week</u></b>', '', None, FX_PLACE_LAST_WEEK, None, 0, None))
        else: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -4, 'This Week', '', None, FX_PLACE_LAST_WEEK, None, 0, None))
 
        if self.parent.curr_place == FX_PLACE_LAST_MONTH: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -5, '<b><u>This Month</u></b>', '', None, FX_PLACE_LAST_MONTH, None, 0, None))
        else: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -5, 'This Month', '', None, FX_PLACE_LAST_MONTH, None, 0, None))
 
        if self.parent.curr_place == FX_PLACE_LAST_QUARTER: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -6, '<b><u>This Quarter</u></b>', '', None, FX_PLACE_LAST_QUARTER, None, 0, None))
        else: 
            self.feed_store_tmp.append(new_row, (self.parent.icons.get('calendar'), -6, 'This Quarter', '', None, FX_PLACE_LAST_QUARTER, None, 0, None))
        ...
        self.feed_store_tmp.append(None, (None, -99, None, None, None, -1, None, 0, None))
        ...
        for c in self.parent.FX.MC.feeds:
            ...
            cat_row = self.feed_store_tmp.append(None, (icon, id, name, subtitle, None, -1, ids, 0, None)) 
        ...
        rss_row = self.feed_store_tmp.append(None, (self.parent.icons.get('rss'), -20, 'RSS', '', None, FX_PLACE_ALL_CHANNELS, None, 0, None))
        for f in self.parent.FX.MC.feeds:
            self.feed.populate(f)
        ...
        html_row = self.feed_store_tmp.append(None, (self.parent.icons.get('www'), -21, 'HTML', '', None, FX_PLACE_ALL_CHANNELS, None, 0, None))
        for f in self.parent.FX.MC.feeds:
            self.feed.populate(f)
        ...
        script_row = self.feed_store_tmp.append(None, (self.parent.icons.get('script'), -22, 'Script', '', None, FX_PLACE_ALL_CHANNELS, None, 0, None))
        for f in self.parent.FX.MC.feeds:
            self.feed.populate(f)
        ...
        local_row = self.feed_store_tmp.append(None, (self.parent.icons.get('local'), -23, 'Local', '', None, FX_PLACE_ALL_CHANNELS, None, 0, None))
        for f in self.parent.FX.MC.feeds:
            self.feed.populate(f)
        ...
        if self.parent.curr_place == 'trash_bin': deleted_row = self.feed_store_tmp.append(None, (self.parent.icons.get('trash', None), -30, '<b>Trash</b>', '', None, FX_PLACE_TRASH_BIN, None, 1, None))            
        else: deleted_row = self.feed_store_tmp.append(None, (self.parent.icons.get('trash', None), -30, 'Trash', '', None, FX_PLACE_TRASH_BIN, None, 1, None)) 
