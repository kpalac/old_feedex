...
#
    ...
    def find_similar(self, id, **kargs):
        ...
        if kargs.get("print",self.print):
            ...
            self.cli_table_print(RESULTS_SQL_TABLE_PRINT, self.results, mask=columns, 
                            ...
                            number_footnote=_('similar documents'), date_col=self.result.get_index('pubdate_short'), html_cols=RESULTS_SQL_TABLE)
    ...
    def term_net(self, term:str, **kargs):
        ...
        if kargs.get('print',self.print):
            self.cli_table_print((n_("Term"), n_("Weight"), n_("Documents")), self.results, output='csv', html_cols=('term', 'weight', 'count',))
