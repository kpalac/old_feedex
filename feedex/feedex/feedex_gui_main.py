...
class FeedexMainWin(Gtk.Window):
    ...
    def __init__(self, **kargs):
        ...
        # Actions and Places
        self.curr_actions = {'fetch':False, 'feed_update':False, 'edit_entry':False, 'add_search':False}
    ...
    def _on_key_press(self, widget, event):
        ...
        if ctrl and key_name == self.config.get('gui_key_search','s'): self.curr_actions['add_search'] = True
    ...
    def _on_timer(self, *kargs):
        ...
        if self.curr_actions != self.prev_actions:
            ...
            # This one is needed to prevent opening multiple tabs on combination pressed 
            if self.curr_actions['add_search']:
                self.curr_actions['add_search'] = False
                self.add_tab({'type':'search'})
