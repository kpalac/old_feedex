...
class FeedexMainWin(Gtk.Window):
    ...
    def _rbutton_press(self, widget, event, from_where):
        ...
        if event.button == 3:
            ...
            elif from_where  == FX_TAB_TIME_SERIES:            
                menu = Gtk.Menu()
    ...
    def on_find_similar(self, *args):
        ...
        self.add_tab({'type': FX_TAB_SIMILAR, 'filters': filters})
    ...
    def add_tab(self, *args):
        ...
        elif type == FX_TAB_SIMILAR: self.upper_pages[tab_id].query(self.selection_res, kargs.get('filters',{}))
