...
class FeedexMainWin(Gtk.Window):
    ...
    def __init__(self, feedex_main_container, **kargs):
        ...
        self.main_menu.append( f_menu_item(1, 'Rules', self.add_tab, kargs={'type':FX_TAB_RULES}, icon='view-list-compact-symbolic', tooltip='Open a new tap showing Saved Rules') )
        ...
        if event.button == 3:
            ...
            if from_where in (FX_TAB_RESULTS, FX_TAB_CONTEXTS):
                ...
                if self.selection_res['id'] is not None:
                    ...
                    author_menu.append( f_menu_item(1, 'Search WWW', self._on_www_search, icon='edit-find-symbolic', tooltip="Search WWW for this Author's info" ) )
    ...
    def _on_www_search(self, *args, **kargs): ext_open(self.config, 'search_engine', self.selection_res.get('author',None))
