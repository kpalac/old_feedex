...
coalesce(field_id, '-- All --') as field,
coalesce(feed_id, '-- All --') as feed

from rules where coalesce(learned,0) = 0
"""
PRINT_RULES_TABLE = ("ID","Name","Search string","Weight","Case insensitive?","Type", "Learned?","Flag?","Field","Feed/Category")
...
( select r1.context_id from rules r1 where r1.name = :name)
...
FEEDS_PRINT_SQL="""select f1.*, coalesce(f2.name, '<NONE>') as feedex_category
from feeds f1
...
RESULTS_SQL_TYPES                = ENTRIES_SQL_TYPES + (str, str, str, str, str, float, int)
...
FEEDS_SQL_TABLE       =  ('id','charset','lang','generator','url','login','domain','passwd','auth','author','author_contact','publisher','publisher_contact',
                                ...
                                'autoupdate','http_status','etag','modified','version','is_category','parent_id', 'handler','deleted', 'user_agent')
FEEDS_SQL_TYPES = (int,  str, str, str, str, str,str, str, str, str, str,str, str, str, str, str,str, str, str, str, str, str, str,
                  int, int, int,   str, str, str, str,   int, int,    str, int,     str)
...
FEEDS_SQL_TABLE_PRINT = ("ID", "Character encoding", "Language", "Feed generator", "URL", "Login", "Domain", "Password", "Authentication method", "Author", "Author - contact",
                                ...
                                "Category ID", "Handler", "Deleted?", "User Agent")


FEEDS_SHORT_PRINT      = ("ID", "Name", "Title", "Subtitle", "Category", "Tags", "Publisher", "Author", "Home link", "URL", "Feedex Category", "Deleted?", "User Agent")
...
RULES_SQL_TABLE_PRINT =  ('ID','Name','Type','Feed ID', 'Field ID', 'Search string', 'Case insensitive?', 'Language', 'Weight', 'Additive?', 'Learned?','Context Entry ID', 'Flag?')
...
CONFIG_NAMES = {
            ...
            'gui_flag_1_color': 'Flag 1 color',
            'gui_flag_1_name': 'Flag 1 name',
            'gui_flag_2_color': 'Flag 2 color',
            'gui_flag_2_name': 'Flag 2 name',
            'gui_flag_3_color': 'Flag 3 color',
            'gui_flag_3_name': 'Flag 3 name',
            'gui_flag_4_color': 'Flag 4 color',
            'gui_flag_4_name': 'Flag 4 name',
            'gui_flag_5_color': 'Flag 5 color',
            'gui_flag_5_name': 'Flag 5 name',
...
CONFIG_STRINGS=('log','db_path','browser','user_agent','gui_flag_1_color','gui_flag_2_color','gui_flag_3_color','gui_flag_4_color','gui_flag_5_color',\
    'gui_new_color','gui_deleted_color', 'gui_hilight_color', 'imave_viewer','text_viewer','bold_markup_beg','bold_markup_end')
...
'gui_fetch_periodically', 'use_search_habits', 'save_perm_redirects', 'mark_deleted')
