...
ENTRIES_SQL_TABLE =      ('id','feed_id','charset','lang','title','author','author_contact','contributors','publisher','publisher_contact',
                                ...
                                'weight','flag','images','enclosures','tokens_raw','deleted','note')

ENTRIES_SQL_TYPES = (int, int,  str, str, str, str, str, str, str, str, str,  int, str,   str, str, str, str, str, str, str,   int, str,
                     str, int, float,     str,    int, int, int, int, int, int, int,    float, float,   int,   str, str, str,   int,  int )
...
ENTRIES_SQL_TABLE_PRINT = (n_("ID"), n_("Source/Category"), n_("Character encoding"), n_("Language"), n_("Title"), n_("Author"), n_("Author - contact"), n_("Contributors"), n_("Publisher"), n_("Publisher - contact"),
                                  ...
                                  n_("Numerals count"), n_("Capitalized words count"), n_("Readability"), n_("Weight"), n_("Flag"), n_("Images"), n_("Enclosures"), n_("Raw Token string (for term context)"), n_("Deleted?"), n_("Note?"))
...
ENTRIES_TECH_LIST = ('tokens','tokens_raw','sent_count','word_count','char_count','polysyl_count','com_word_count','numerals_count','caps_count','readability','weight','importance','adddate','adddate_str')
...
from feedex_ling_processor import LingProcessor
