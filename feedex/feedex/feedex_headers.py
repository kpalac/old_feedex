...
-49 : ('Input data is not a list', False, True),
-50 : ('Invalid element dictionary format!', False, True),
-51 : ('Error exporting feeds to %a. Operation aborted', False, True),
-52 : ('Error exporting rules to %a. Operation aborted', False, True),
-53 : ('Error saving results to %a!', False, True),
...
74 : ('No keywords found for entry %a', False, False),
}
