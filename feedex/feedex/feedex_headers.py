...
CONFIG_BOOLS=('notify','ignore_images', 'use_keyword_learning', 'learn_from_added_entries','do_redirects','ignore_modified','gui_desktop_notify','gui_fetch_periodically')
