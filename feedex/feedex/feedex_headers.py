...
where coalesce(f1.is_category,0) = 0"""
...
CONFIG_STRINGS=('log','db_path','browser','user_agent','gui_flag_1_color','gui_flag_2_color','gui_flag_3_color','gui_flag_4_color','gui_flag_5_color',\
    'gui_new_color','gui_deleted_color', 'gui_hilight_color', 'imave_viewer','text_viewer','search_engine','bold_markup_beg','bold_markup_end')
